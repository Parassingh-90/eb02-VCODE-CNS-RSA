...
function recieve(){
    ...
    document.getElementById('decrypted').style.animation = 'example3 4s';
    document.getElementById('decrypted').style.animationDelay = '2s';
    document.getElementById('decrypted').style.animationFillMode = 'both';
    document.getElementById('decrypted').style.animationTimingFunction = 'ease-in-out';
}
