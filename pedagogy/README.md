...
:--|:--|:--|:-:
1.|User will be able to remember the concept of prime number|identify the prime number|<div align="justify">Which one of the following is not a prime number?<br></div>A.31<br>B.61<br>C.71<br>D.91</b><br>(D)</b>
2.|User will be able to understand the concept of Key Generation <br> using RSA algorithm|Provide 2 large prime number P and Q |<div align="justify">RSA stands for___<br></div>A.Rock Shane and Amozen<br>B.Rivest Shamir and Adleman<br>C.Rivest Shamir and Amozen<br>DRock Shamir and Adleman</b><br><b>(B)</b>
